...
public class ShopServiceImpl implements ShopService {
    ...
    public ShopExecution addShop(Shop shop, File shopImgInputStream) {
            ...
            if(effectedNum<=0){
                ...
                if(shopImgInputStream != null){
                    try {
                        ...
                        addShopImgInputStream(shop,shopImgInputStream);
     ...
     * @param shopImg
     */
    private void addShopImgInputStream(Shop shop, File shopImg) {
